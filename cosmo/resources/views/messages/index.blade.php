        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                <div class="card bg-dark text-white">
                    <div class="card-header bg-secondary text-white">Your Conversations</div>
                ...
                <div class="card bg-dark text-white d-flex flex-column" style="height: 70vh">
                    @isset($receiver)
                        <div class="card-header bg-secondary text-white d-flex align-items-center">
                            <img
                                src="{{ $receiver->profile_image ? asset('storage/' . $receiver->profile_image) : asset('user-placeholder.png') }}"
                                class="rounded-circle me-2"
                                style="width: 32px; height: 32px; object-fit: cover"
                            />
                        ...
                        <div
                            class="flex-grow-1 overflow-auto px-3 py-2 chat-thread"
                            id="chat-thread"
                        >
                                    ...
                                    <div class="d-flex justify-content-end mb-3">
                                        <div class="text-end">
                                            ...
                                            >
                                                ...
                                                <div
                                                    class="bg-primary text-white rounded p-2 chat-bubble"
                                                >
                                                    {{ $message->body }}
                                                </div>
                                            </div>
                                        ...
                                        <img
                                            src="{{ $message->sender->profile_image ? asset('storage/' . $message->sender->profile_image) : asset('user-placeholder.png') }}"
                                            alt="avatar"
                                ...
                                @else
                                    <div class="d-flex mb-3">
                                        ...
                                        <div>
                                            ...
                                            <div
                                                class="bg-secondary text-white rounded p-2 mb-1 chat-bubble"
                                            >
                                                {{ $message->body }}
                                            </div>
                                            <small class="text-muted">
